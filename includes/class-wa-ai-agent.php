...
class INPURSUIT_WA_AI_Agent {
    ...
    private static function system_prompt( $wp_user ) {
        $prompt = "You are a helpful assistant for InPursuit, a church management system. "
            ...
            . "IMPORTANT: When you receive results from get_member_comments, you MUST write one short readable paragraph that summarises the notes. Never list or quote the individual notes. Synthesise them into a flowing paragraph covering key themes, patterns, and recent developments.\n\n"
        ...
        return array(
            ...
            array(
                ...
                'function' => array(
                    ...
                    'description' => 'Get all follow-up notes for a specific member, with dates and categories. Use this when the user asks to see a member\'s notes, follow-up history, or comment history. After receiving the results, summarise everything into one short readable paragraph.',
                    'parameters'  => array(
                        'type'       => 'object',
                        'properties' => array(
                            'name' => array( 'type' => 'string', 'description' => 'The member\'s name (partial names supported).' ),
